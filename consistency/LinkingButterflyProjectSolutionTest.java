...
public class LinkingButterflyProjectSolutionTest {
	@Test
...
//						System.out.println("before wring");
						...
						linkingButterfly.projectSolutionButterfly();
...
//							System.out.println(Arrays.toString(ints));
							...
							testAssertEquals(
								solutionButterfly.areValidRootHadamards(ints), // this seems to work
